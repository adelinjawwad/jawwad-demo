import masterItems from './assets/data/masterItems.js';
...
function showToast(t) {
	...
	document.getElementById("toast-message").textContent = t;
...
function openModal(t) {
	...
	document.getElementById("modal-image").src = t;
	e.classList.remove("hidden");
...
function toggleDropdown() {
	...
	e.style.transform = t.classList.contains("active") ? "rotate(180deg)" : "rotate(0deg)";
}

function loadContent(t) {
	t = t.split("?")[0];
	localStorage.setItem("currentPage", t);
	document.getElementById("content-area").classList.add("opacity-0", "transition-opacity", "duration-300");
