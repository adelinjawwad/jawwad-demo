	...
	const masterItems = {
    costumes: [
        { title: 'Costume Preview', img: 'assets/img/jawwad_mini.jpg', full: 'assets/img/jawwad.jpg' }
    ],
    hairstyles: [
        { title: 'Hairstyle Preview', img: 'assets/img/jawwad_mini.jpg', full: 'assets/img/jawwad.jpg' }
    ],
    weapons: [
        { title: 'Weapon Preview', img: 'assets/img/jawwad_mini.jpg', full: 'assets/img/jawwad.jpg' }
    ],
    others: [
        { title: 'Other Asset Preview', img: 'assets/img/jawwad_mini.jpg', full: 'assets/img/jawwad.jpg' }
    ],
    free: [
